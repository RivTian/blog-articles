---
title: "拓扑排序"
date: 2020-04-05T14:40:44+08:00
draft: false
tags:
  - 图论
topics:
...
因此我们可以说 在一个 [DAG（有向无环图）](https://www.cnblogs.com/RioTian/p/13377932.html) 中，我们将图中的顶点以线性方式进行排序，使得对于任何的顶点 $u$ 到 $v$ 的有向边 $(u,v)$ , 都可以有 $u$ 在 $v$ 的前面。
...
![topo](https://gitee.com//riotian/blogimage/raw/master/img/20200725193146.png)
