...
<font color="#ff0000"><b>迭代器运算符中没有迭代器加迭代器的操作</b></font>
...
编写3个不同版本的程序，令其均输出ia的元素。
* 版本1使用范围for语句管理迭代过程；
* 版本2和版本3都使用普通for语句，其中版本2要求用下标运算符，
* 版本3要求用指针。
此外在所有3个版本的程序中都要直接写出数据类型，而不能使用类型别名、auto关键字或decltype关键字。
